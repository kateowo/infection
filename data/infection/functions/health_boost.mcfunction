...
execute if score percent alive_players matches 20..35 unless score percent25 internal matches 1 if score period internal matches 2 run worldborder set 450 400
# Set new victory timeout
execute if score percent alive_players matches 20..35 unless score percent25 internal matches 1 run scoreboard players set time_s internal 0
...
execute if score percent alive_players matches 36..50 unless score percent50 internal matches 1 if score period internal matches 2 run worldborder set 300 400
# Set new victory timeout
execute if score percent alive_players matches 36..50 unless score percent50 internal matches 1 run scoreboard players set time_s internal 0
...
execute if score percent alive_players matches 60..79 unless score percent75 internal matches 1 if score period internal matches 2 run worldborder set 260 400
# Set new victory timeout
execute if score percent alive_players matches 60..79 unless score percent75 internal matches 1 run scoreboard players set time_s internal 0
...
execute if score percent alive_players matches 80..100 unless score percent100 internal matches 1 if score period internal matches 2 run worldborder set 120 400
# Set new victory timeout
execute if score percent alive_players matches 80..100 unless score percent100 internal matches 1 run scoreboard players set time_s internal 0
